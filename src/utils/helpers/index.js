// export const buildUrlParams = (originUrl, urlParams) => {
//     let newUrl = originUrl;
//     newUrl = newUrl.replace(/ *\{[^}]*\} */g, urlParams);
//     return newUrl;
// };
...
export const convertStrToDateTime = (str) => {
    const date = new Date(str);
    return date.toString();
};

export const cookRowCountries = (arrCountries) => {
    return arrCountries.map((country) => {
        return {
